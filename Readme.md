...
## Train
You can train SGHR with the 3dmatch_train dataset downloaded above, where we offer the 32-dim **rotation-invariant** yoho-desc we extracted on 3dmatch_train and you can also [extract them yourself](https://github.com/HpWang-whu/YOHO) and save them to '''data/3dmatch_train/<scene>/yoho_desc'''.
